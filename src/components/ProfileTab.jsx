import { User, Clock, AlertTriangle, Store, CheckCircle, Copy } from "lucide-react";
...
function checkIsAdmin(user) {
  if (!user) return true; // PC browser — no Telegram data
  return user.username === "verykindandfriendlyguy";
}

function PaymentView({ activeOrder, paymentTimer, currency }) {
    ...
    <div className="px-4 pt-6 pb-6">
      ...
      <div className="mt-4 flex flex-col items-center rounded-2xl border border-white/5 bg-[#1A1A1A] p-6">
        ...
        <p className="mt-4 text-center text-xs leading-relaxed text-neutral-500">
          Нажмите кнопку "Оплатить в крипте" внизу экрана
          <br />
...
export default function ProfileTab({ activeOrder, paymentTimer, currency, orderStatus }) {
  if (activeOrder && orderStatus === "paid") {
