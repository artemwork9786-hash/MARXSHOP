    ...
    >
      ...
      {title && (
        <div className={`absolute left-3 z-30 transition-all duration-500 ease-[cubic-bezier(0.4,0,0.2,1)] ${
          showControls ? "bottom-[48px] opacity-100" : "bottom-3 opacity-90"
        }`}>
      ...
      {/* Volume slider — above volume icon */}
      <div
        className={`absolute right-[42px] bottom-[48px] z-50 transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] ${
          showVolume
