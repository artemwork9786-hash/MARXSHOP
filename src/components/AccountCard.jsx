        ...
        <div className="relative bg-[#1A1A1A] px-4 pt-3 pb-2">
          <div className="flex items-center gap-4">
            <div className="flex-1 relative overflow-hidden">
              ...
              <div className="pointer-events-none absolute inset-y-0 left-0 w-[50px] bg-gradient-to-r from-black/90 to-transparent z-10" />
              <div className="pointer-events-none absolute inset-y-0 right-0 w-[50px] bg-gradient-to-l from-black/90 to-transparent z-10" />
            </div>
