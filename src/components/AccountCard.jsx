          ...
          <>
            ...
            {title && (
              <div className={`absolute left-3 z-30 transition-all duration-500 ease-[cubic-bezier(0.4,0,0.2,1)] ${showControls ? "bottom-[52px] opacity-100" : "bottom-3 opacity-90"}`}>
                <div className="relative rounded-lg border border-white/10 shadow-[0_4px_24px_rgba(0,0,0,0.5)]">
                  <div className="absolute inset-0 rounded-lg bg-black/40 backdrop-blur-xl" style={{ transform: "translateZ(0)", willChange: "backdrop-filter", WebkitBackdropFilter: "blur(24px) saturate(140%)", backdropFilter: "blur(24px) saturate(140%)" }} />
