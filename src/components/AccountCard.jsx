    ...
    >
      ...
      {title && (
        <div className={`absolute left-3 z-30 transition-all duration-500 ease-[cubic-bezier(0.4,0,0.2,1)] ${
          showControls ? "bottom-[44px] opacity-100" : "bottom-3 opacity-90"
        }`}>
      ...
      >
        {/* Volume slider — positioned above volume icon */}
        <div
          className={`absolute right-4 bottom-full mb-2 z-50 transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] ${
            showVolume
        ...
        >
          <div className="flex flex-col items-center p-2 rounded-xl border border-white/10 bg-black/60 backdrop-blur-lg shadow-[0_8px_24px_rgba(0,0,0,0.6)] origin-bottom">
            <div
              ref={volumeRef}
              className="relative h-20 w-6 cursor-pointer touch-none select-none"
