...
function GlassPlayer({ src, poster, title, status }) {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={`flex flex-col items-center p-2 rounded-xl border border-white/10 bg-black/60 backdrop-blur-lg shadow-[0_8px_24px_rgba(0,0,0,0.6)] origin-bottom transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] ${
            showVolume
